...
def eval(text_input,key_target,time_target,tempo_target,args):
    ...
    for i in range(int(args.num_generate)):
        ...
        if float(args.uncond_scale) == 0.0:
            ...
            if args.from_midi is not None:
                ...
                prmat2c, pnotree, prmat, text = get_data_preprocessed(
                    data_sample, "cond"
                )
